...
export default function NightNB({ width, height, color }) {
  return (
    <svg width={width} height={height} viewBox="0 0 64 64" fill="none">
      <g clipPath="url(#clip0)">
        ...
        />
        <path
          d="M50.4561 55.0705C53.176 55.0705 55 53.2465 55 50.5267C55 47.8075 53.176 44.6846 50.4561 44.6846C50.4561 37.885 44.2732 33.0004 37.4737 33.0004C31.4557 33.0004 26.2127 37.0321 25.1404 42.7372C25.1404 42.7372 24.3406 42.7372 23.8421 42.7372C20.442 42.7372 18 45.8283 18 49.2284C18 52.6285 20.442 55.0705 23.8421 55.0705H50.4561Z"
          fill="white"
          stroke={color}
          strokeWidth="2"
          strokeMiterlimit="10"
